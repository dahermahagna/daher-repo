...
public:
    ...
    PublicConvoy(const PublicConvoy &other_) : m_pt1(new Minibus(*(Minibus *)other_.m_pt1)),
                                               m_pt2(new Taxi(*(Taxi *)other_.m_pt2)),
                                               m_m(other_.m_m),
                                               m_t(other_.m_t)
    {
        
        /* *this->m_pt1 = other_.m_pt1;
        *this->m_pt2 = other_.m_pt2; */
    }
